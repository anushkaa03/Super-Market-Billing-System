...
class Login_App:
    def __init__(self, root):
        self.root = root
        self.root.geometry("300x150+500+200")#window size'''
        self.root.title("Login") #Window title'''

        # Variables
        self.username = StringVar() #for text entry'''
        self.password = StringVar()

        # Login Label Frame
        login_frame = LabelFrame(self.root, text="Login", font=("Arial Black", 12), bg="#A569BD", fg="white", relief=GROOVE, bd=10)
        login_frame.place(x=0, y=0, relwidth=1, relheight=1)

        username_label = Label(login_frame, text="Username", font=("Arial Black", 14), bg="#A569BD", fg="white").grid(row=0, column=0, padx=10, pady=10)
        username_entry = Entry(login_frame, borderwidth=4, width=20, textvariable=self.username).grid(row=0, column=1, padx=10, pady=10)

        password_label = Label(login_frame, text="Password", font=("Arial Black", 14), bg="#A569BD", fg="white").grid(row=1, column=0, padx=10, pady=10)
        password_entry = Entry(login_frame, borderwidth=4, width=20, textvariable=self.password, show="*").grid(row=1, column=1, padx=10, pady=10)

        login_button = Button(login_frame, text="Login", font=("Arial Black", 12), bg="#E5B4F3", fg="#6C3483", command=self.check_credentials).grid(row=2, column=1, padx=10, pady=10)
...
class Bill_App:
    def __init__(self,root):
        ...
        self.root.title("Super Market Billing System by Anushka")
        title=Label(self.root,text="Super Market Billing System",bd=12,relief=RIDGE,font=("Arial Black",20),bg="#A569BD",fg="white").pack(fill=X)
        #===================================variables=======================================================================================
        self.nutella=IntVar()
        self.noodles=IntVar()
        self.lays=IntVar()
        ...
        item13=Label(grocery,text="DAL",font=("Arial Black",11),bg="#E5B4F3",fg="#6C3483").grid(row=5,column=0,pady=11)
        ...
        #========================================Snacks===============================================================================
        hygine=LabelFrame(self.root,text="DAILY ESSENTIALS",font=("Arial Black",12),relief=GROOVE,bd=10,bg="#E5B4F3",fg="#6C3483")
        ...
        total_hygine=Label(billing_menu,text="Total DAILY ESSENTIALS Price",font=("Arial Black",11),bg="#A569BD",fg="white").grid(row=2,column=0)
        ...
        tax_hygine=Label(billing_menu,text="Daily Essentials Tax",font=("Arial Black",11),bg="#A569BD",fg="white").grid(row=2,column=2)
...
def total(self):
    ...
    self.pa=self.pasta.get()*60
    self.oi=self.oil.get()*110
    self.ri=self.rice.get()*160
    self.su=self.sugar.get()*55
    self.te=self.tea.get()*80
